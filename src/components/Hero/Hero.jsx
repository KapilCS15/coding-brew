          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 place-items-center min-h-[850px]">
            ...
            <div className="hidden lg:block">
              ...
              >
                ...
                <div className="relative">
                  <div className="relative z-10 space-y-4">
                    <h1 className="text-2xl font-thin">Heavy Bodied, <br />rich coffees at 50% off</h1>
                    <h1 className="text-sm opacity-55 leading-loose">
                    Our French Press is a classic and affordable piece of equipment that brews a strong full-bodied cup of coffee. This one is highly versatile, as in addition to making a strong cup of coffee,
                    </h1>
                  </div>
